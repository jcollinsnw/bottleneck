# bottleneck-client-side

This is a client side version of Bottleneck. I wanted to run this in the browser to allow me to throttle API requests during a data dump with 3,000+ api calls.
